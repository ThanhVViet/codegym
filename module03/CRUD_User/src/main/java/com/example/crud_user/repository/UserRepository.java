...
public class UserRepository implements IUserRepository<User> {
    ...
    private static  final String SELECT_PRODUCT_BY_NAME = "select * from users where id  = ?";
    ...
    private static  final String SELECT_PRODUCT_BY_ID = "select * from users where name like concat('%',?,'%');";
    @Override
