...
public class TableList {
    ...
    private int spacing;
    private Case_Study.utils.TableList.EnumAlignment aligns[];
    ...
    public TableList(int columns, String... descriptions) {
        ...
        this.ucode = false;
        this.spacing = 1;
        this.aligns = new Case_Study.utils.TableList.EnumAlignment[columns];
        this.comparator = null;
        for (int i = 0; i < aligns.length; i++) {
            aligns[i] = Case_Study.utils.TableList.EnumAlignment.LEFT;
        }
    }
    ...
    public TableList align(int column, Case_Study.utils.TableList.EnumAlignment align) {
        aligns[column] = align;
        return this;
    }
